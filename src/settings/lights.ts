...
export const lightConfigs: LightConfigs = [
  ...
  {
    name: 'front_distant_upper_light',
    variant: 'PointLight',
    position: {
      x: 4.4,
      y: 5.8,
