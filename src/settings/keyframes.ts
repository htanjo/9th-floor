...
export const keyframes: Keyframes = [
  ...
  },
  {
    ...
    backwardRotationOffset: { x: toRadians(20), y: toRadians(-3), z: 0 },
    areaName: 'stairs',
  },
  {
    position: { x: 2.3, y: 3.3, z: -16.5 },
    forwardRotationOffset: { x: toRadians(48), y: 0, z: 0 },
    backwardRotationOffset: { x: toRadians(15), y: toRadians(10), z: 0 },
    areaName: 'stairs',
  },
  {
    position: { x: 2.0, y: 2.1, z: -14.1 },
    forwardRotationOffset: { x: toRadians(25), y: toRadians(20), z: 0 },
    backwardRotationOffset: { x: toRadians(-5), y: toRadians(-35), z: 0 },
    areaName: 'stairs',
  },
  {
    position: { x: 2.5, y: 1.5, z: -12 },
    forwardRotationOffset: { x: toRadians(5), y: toRadians(-50), z: 0 },
    backwardRotationOffset: { x: toRadians(25), y: 0, z: 0 },
    areaName: 'lower_floor',
  },
  {
    position: { x: 3.6, y: 1.5, z: -9.5 },
    forwardRotationOffset: { x: toRadians(35), y: toRadians(20), z: 0 },
    backwardRotationOffset: { x: toRadians(-5), y: toRadians(50), z: 0 },
    areaName: 'lower_floor',
  },
  {
  ...
  },
  {
    ...
    backwardRotationOffset: { x: toRadians(15), y: toRadians(35), z: 0 },
    areaName: 'lower_floor',
  },
  {
