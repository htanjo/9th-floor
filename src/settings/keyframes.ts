...
export const keyframes: Keyframes = [
  ...
  },
  {
    ...
    forwardRotationOffset: { x: 0, y: toRadians(10), z: 0 },
  ...
  },
  {
    ...
    backwardRotationOffset: { x: 0, y: toRadians(-50), z: 0 },
    areaName: 'stairs',
  },
  {
    position: { x: 4.5, y: 4.5, z: -14.1 },
    forwardRotationOffset: { x: toRadians(45), y: toRadians(15), z: 0 },
    backwardRotationOffset: { x: toRadians(5), y: toRadians(10), z: 0 },
    areaName: 'stairs',
  },
  {
  ...
  },
  {
    ...
    backwardRotationOffset: { x: toRadians(15), y: toRadians(-20), z: 0 },
    areaName: 'stairs',
  },
  {
  ...
  },
  {
    ...
    backwardRotationOffset: { x: toRadians(18), y: toRadians(30), z: 0 },
    areaName: 'floor_1',
  },
  {
