import{b4 as e}from"./Screen-74ErTxBJ.js";import"./oitFragment-DACe3mY9.js";import"./harmonicsFunctions-CDsyuHKk.js";import"./mainUVVaryingDeclaration-Bp84uEG8.js";import"./hdrFilteringFunctions-DJSB_qFB.js";import"./index-o77hDTBp.js";const a="pbrFragmentExtraDeclaration",n=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
return result;}`;e.IncludesShadersStoreWGSL[m]=R;const S="pbrDirectLightingFalloffFunctions",v=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
`;e.IncludesShadersStoreWGSL[W]=X;const k="pbrBlockNormalFinal",Y=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;e.IncludesShadersStoreWGSL[k]=Y;const w="pbrBlockLightmapInit",z=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStoreWGSL[w]=z;const K="pbrBlockGeometryInfo",$=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
`;e.IncludesShadersStoreWGSL[oe]=ce;const le="pbrDebug",de=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[le]=de;const i="pbrPixelShader",r=`#define CUSTOM_FRAGMENT_BEGIN
...
}`;e.ShadersStoreWGSL[i]=r;const ue={name:i,shader:r};export{ue as pbrPixelShaderWGSL};
