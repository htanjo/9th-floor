import{b4 as e}from"./Screen-CCpPMwv_.js";import"./defaultUboDeclaration-B3VanQ5g.js";import"./oitFragment-KB0hVA44.js";import"./mainUVVaryingDeclaration-CTD_QY0n.js";const r="lightsFragmentFunctions",o=`struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
#endif
...
#endif
return result;}
fn computeProjectionTextureDiffuseLighting(projectionLightTexture: texture_2d<f32>,projectionLightSampler: sampler,textureProjectionMatrix: mat4x4f,posW: vec3f)->vec3f {var strq: vec4f=textureProjectionMatrix*vec4f(posW,1.0);strq/=strq.w;var textureColor: vec3f=textureSample(projectionLightTexture,projectionLightSampler,strq.xy).rgb;return textureColor;}`;e.IncludesShadersStoreWGSL[r]=o;const a={name:r,shader:o},v=Object.freeze(Object.defineProperty({__proto__:null,lightsFragmentFunctionsWGSL:a},Symbol.toStringTag,{value:"Module"})),n="fresnelFunction",t=`#ifdef FRESNEL
fn computeFresnelTerm(viewDirection: vec3f,worldNormal: vec3f,bias: f32,power: f32)->f32
{let fresnelTerm: f32=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStoreWGSL[n]=t;const f="defaultPixelShader",i=`#include<defaultUboDeclaration>
...
`;e.ShadersStoreWGSL[f]=i;const l={name:f,shader:i},u=Object.freeze(Object.defineProperty({__proto__:null,defaultPixelShaderWGSL:l},Symbol.toStringTag,{value:"Module"}));export{v as a,u as b,l as d,a as l};
