import{b4 as e}from"./Screen-WD6sCfJC.js";import"./oitFragment-DKtVTURM.js";import"./harmonicsFunctions-CnpSomJW.js";import"./mainUVVaryingDeclaration-ibxEgRds.js";import"./hdrFilteringFunctions-FIDLSN7v.js";import"./index-BI95D3_M.js";const a="pbrFragmentDeclaration",r=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
#endif
return result;}`;e.IncludesShadersStore[A]=u;const m="pbrDirectLightingFalloffFunctions",S=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
`;e.IncludesShadersStore[L]=g;const M="pbrBlockAmbientOcclusion",D=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[M]=D;const _="pbrBlockAlphaFresnel",h=`#ifdef ALPHAFRESNEL
...
#endif
`;e.IncludesShadersStore[U]=b;const B="pbrBlockSheen",y=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[B]=y;const G="pbrBlockClearcoat",V=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[G]=V;const H="pbrBlockIridescence",x=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[le]=de;const se="pbrDebug",Ee=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[se]=Ee;const i="pbrPixelShader",n=`#if defined(BUMP) || !defined(NORMAL) || defined(FORCENORMALFORWARD) || defined(SPECULARAA) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
...
`;e.ShadersStore[i]=n;const Ie={name:i,shader:n};export{Ie as pbrPixelShader};
