import{b4 as r}from"./Screen-CGaI1_kx.js";import"./index-DY4PRcav.js";const e="glowBlurPostProcessPixelShader",t=`varying vec2 vUV;uniform sampler2D textureSampler;uniform vec2 screenSize;uniform vec2 direction;uniform float blurWidth;float getLuminance(vec3 color)
...
gl_FragColor=baseColor;}`;r.ShadersStore[e]=t;const l={name:e,shader:t};export{l as glowBlurPostProcessPixelShader};
